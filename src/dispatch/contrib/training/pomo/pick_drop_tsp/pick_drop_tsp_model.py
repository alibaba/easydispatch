...
class PickDropTSPModel(nn.Module):
...
class PickDropTSP_Decoder(nn.Module):
    ...
    def set_kv(self, encoded_nodes, job_loc_idx):
        ...
        self.k = reshape_by_heads(self.Wk(gathered_encoded_nodes), head_num=head_num)
        self.v = reshape_by_heads(self.Wv(gathered_encoded_nodes), head_num=head_num)
