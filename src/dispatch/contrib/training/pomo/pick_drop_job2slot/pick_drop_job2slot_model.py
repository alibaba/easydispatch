...
class PickDropJob2SlotModel(nn.Module):
    ...
    def pre_forward(self, reset_state):
        ...
        self.encoded_nodes = self.encoder(
            torch.cat((worker_xy_2,job_xy_2),dim=1)
        )
    ...
    def _get_worker_encoding(self, step_state):
        ...
        batch_size, pomo_size, worker_size,max_job_in_worker_size = step_state.scheduled_job_idx.size()

        job_gather_index = step_state.scheduled_job_idx[:,:,:,:,None].repeat(
    ...
    def _get_job_encoding(self, step_state, batch_size, pomo_size):
        ...
        job_idx = step_state.current_job_idx # + step_state.reset_state.worker_size
