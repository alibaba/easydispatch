...
from .single_job2slot_n2s_model_nets import NodePairRemovalDecoder, NodePairReinsertionDecoder, get_initial_insert_mask, get_removal_node_mask, get_swap_insert_mask


class SingleJob2SlotN2SModel(nn.Module):
    ...
    def forward_job2slot(self, step_state): 
        ...
        pos_pickup = step_state.reset_state.job_loc_idx[:,:, job_idx:job_idx + 1]# .repeat(1, embedding_dim)
    ...
    def forward_swap(self, step_state):
        ...
        swap_insert_mask = get_swap_insert_mask(
            ...
            allow_changing_worker_flag = step_state.allow_changing_worker_flag,
