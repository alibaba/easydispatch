...
class TSPModel(nn.Module):
    ...
    def _pre_forward_orig(self, reset_state):
        pass
    ...
    def forward(self, state):
        ...
        if state.current_node is None:
            ...
            probs = torch.zeros(batch_size, pomo_size, state.reset_state.problems.size(1)) + 0.1
            ...
            if self.pad_mask is None:
                new_ninf_mask = state.ninf_mask
            else:
                new_ninf_mask = state.ninf_mask + self.pad_mask
