...
setup(
    ...
    entry_points={
        ...
        "dispatch.plugins": [
            ...
            "ortools_n_days_planner = dispatch.plugins.kandbox_planner.planner_engine.opti1day.ortools_n_days_planner:OrtoolsNDaysPlanner",
            "kandbox_opti1day = dispatch.plugins.kandbox_planner.planner_engine.opti1day.opti1day_planner:Opti1DayPlanner",
            "kandbox_ortools_cvrp_planner = dispatch.plugins.kandbox_planner.planner_engine.opti1day.ortools_cvrp_planner:OrtoolsCVRPPlanner",
